...
\"\n\
checkout_executable TCLSH \"/home/sem/ns2/ns-allinone-2.29-ori/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/sem/ns2/ns-allinone-2.29-ori/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
$self setup [AddrParams addr2id $args] $bb_ $lmp_ $l2cap_ $bnep_ $sdp_\n\
}\n\
\n\
