...
set udp_mr_ha2 [new Agent/UDP/Udpmysip]
...
$udp_mr_ha2 set-node-type $node_type_sip(SIP_MR_HA)
$udp_mr set-node-type $node_type_sip(SIP_MR)

$udp_r set-sip-mn 88 5.0.0 8888 5.0.0 $nemo_mn_eface1

$udp_mr set-sip-mr 88 8.0.0 9999 8.0.0 6.0.0 $nemo_mr_eface1 $nemo_mr_iface1
$udp_mr set-sip-mr 88 9.0.0 9998 8.0.0 7.0.0 $nemo_mr_eface2 $nemo_mr_iface1

$router0 attach $udp_s 3
$router2 attach $udp_server 3
$router3 attach $udp_mr_ha 3
$router4 attach $udp_mr_ha2 3
...
$udp_mr_ha2 set packetSize_ 1000
